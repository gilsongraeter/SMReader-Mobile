...
public class ProtocoloAbsoluto {
    ...
    static final byte AB03 = 0x03;
    static final byte AB04 = 0x04;
    static final byte AB05 = 0x05;
    static final byte AB08 = 0x08;
    static final byte AB14 = 0x14;
    ...
    public static TipoMedidor TipoMedidorPeloNumeroMedidor(String numeroMedidor, int metodo) {
        String ns = "";
        if (numeroMedidor.length() < 6)
            return TipoMedidor.Hospedeiro;
        if(metodo == 0x02){
            ...
            ns = numeroMedidor.substring(numeroMedidor.length() - 6);
        }
        for (Medidor medidor : medidores) {
            if (medidor.numeroSerie.equals(ns))
                return medidor.tipo;
