...
public class ComandoAbsoluto {
    ...
    public static class EB11QEE {
        ...
        public EB11QEE comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(byte pacote, byte conjunto, int metodo) {
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
    ...
    public static class EB17_2 {
        ...
        public EB17_2 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(byte tipo_comando, int metodo) {
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
    ...
    public static class AB52 {
        ...
        public AB52 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(byte pacote, byte TipoLeitura, int Intervalo, int metodo) {
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
            ...
            corpo[6] = 0x00;
            corpo[7] = TipoLeitura;
            corpo[8] = (byte)(Intervalo & 0xFF);
            corpo[9] = (byte)((Intervalo >> 8) & 0xFF);
            corpo[10] = (byte)((Intervalo >> 16) & 0xFF);
            corpo[11] = (byte)((Intervalo >> 24) & 0xFF);
            return ComandoAbsoluto.GeraMensagem(cabecalho, corpo);
        }
    }

    public static class AB03{
        private String numeroMedidor = "";
        private TipoMedidor tipoMedidor = TipoMedidor.Hospedeiro;
        private byte TipoComando = 0; // Leitura = 0 ou Alteração = 1
        private byte ComandoAtivacao = 0; // Desativa = 0 ou Ativa = 1;
        private byte StatusParametrizacao = 0;
        private byte StatusAtivacao = 0;
        private int UC;
        private long IU;
        private long IUTC;
        private byte IndiceMedidorAtivar;

        public AB03 comNumerMedidor(String numeroMedidor, int metodo) {
            this.tipoMedidor = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.numeroMedidor = numeroMedidor;
            return this;
        }

        public  byte[] build(int metodo, byte Comando, byte Ativacao, int UC, long IU, long IUTC, byte IndiceMedidorAtivar){
            this.TipoComando = Comando;
            this.ComandoAtivacao = Ativacao;
            this.UC = UC;
            this.IU = IU;
            this.IUTC = IUTC;
            this.IndiceMedidorAtivar = IndiceMedidorAtivar;

            byte[] cabecalho = GeraNumeroMedidor(tipoMedidor, numeroMedidor, metodo);
            byte[] corpo = GeraCorpoPerguntaEstendida(ProtocoloAbsoluto.AB03);
            corpo[0] = ProtocoloAbsoluto.ComandoAB;
            corpo[5] = TipoComando;
            corpo[6] = ComandoAtivacao;

            corpo[7] = (byte)(UC & 0xFF);
            corpo[8] = (byte)((UC >> 8) & 0xFF);
            corpo[9] = (byte)((UC >> 16) & 0xFF);
            corpo[10] = (byte)((UC >> 24) & 0xFF);

            corpo[11] = (byte)(IU & 0xFF);
            corpo[12] = (byte)((IU >> 8) & 0xFF);
            corpo[13] = (byte)((IU >> 16) & 0xFF);
            corpo[14] = (byte)((IU >> 24) & 0xFF);
            corpo[15] = (byte)((IU >> 32) & 0xFF);

            corpo[16] = (byte)(IUTC & 0xFF);
            corpo[17] = (byte)((IUTC >> 8) & 0xFF);
            corpo[18] = (byte)((IUTC >> 16) & 0xFF);
            corpo[19] = (byte)((IUTC >> 24) & 0xFF);
            corpo[20] = (byte)((IUTC >> 32) & 0xFF);

            corpo[21] = IndiceMedidorAtivar;

            return GeraMensagem(cabecalho, corpo);
        }

        public void setTipoComando(byte TipoComando) {
            this.TipoComando = TipoComando;
        }

        public void setComandoAtivacao(byte Comando) {
            this.ComandoAtivacao = Comando;
        }

        public byte getStatusParametrizacao() {return this.StatusParametrizacao;}
        public byte getStatusAtivacao() {return this.StatusAtivacao;}

        public void setUC(int UC) {
            this.UC = UC;
        }
        public int getUC(){return this.UC;}

        public void setIU(long IU) {
            this.IU = IU;
        }
        public long getIU(){return this.IU;}

        public void setIUTC(long IUTC) {
            this.IUTC = IUTC;
        }
        public long getIUTC(){return this.IUTC;}

        public String toString(){return "AB03 {" +
                "\nTipo Medidor: " + tipoMedidor +
                "\nNº Medidor: " + numeroMedidor +
                "\n TipoComando" + TipoComando +
                "\n ComandoAtivacao" + ComandoAtivacao +
                "\n";}
    }

    public static class AB04{
        private String numeroMedidor = "";
        private TipoMedidor tipoMedidor = TipoMedidor.Hospedeiro;
        private byte TipoComando = 0; // Leitura = 0 ou Alteração = 1
        private byte StatusParametrizacao = 0;
        ...
        public AB04 comNumerMedidor(String numeroMedidor, int metodo) {
            this.tipoMedidor = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.numeroMedidor = numeroMedidor;
            return this;
        }

        public  byte[] build(int metodo, byte Comando, byte[] CodMostradores){
            this.TipoComando = Comando;

            byte[] cabecalho = GeraNumeroMedidor(tipoMedidor, numeroMedidor, metodo);
            byte[] corpo = GeraCorpoPerguntaEstendida(ProtocoloAbsoluto.AB04);
            corpo[0] = ProtocoloAbsoluto.ComandoAB;
            corpo[5] = TipoComando;
            corpo[6] = CodMostradores[0];
            corpo[7] = CodMostradores[1];
            corpo[8] = CodMostradores[2];
            corpo[9] = CodMostradores[3];
            corpo[10] = CodMostradores[4];
            corpo[11] = CodMostradores[5];
            corpo[12] = CodMostradores[6];
            corpo[13] = CodMostradores[7];
            corpo[14] = CodMostradores[8];
        ...
        public String toString(){return "AB04 {" +
                "\nTipo Medidor: " + tipoMedidor +
                "\nNº Medidor: " + numeroMedidor +
                "\n TipoComando" + TipoComando +
                "\n CodMostraodres" + CodMostradores[0] + CodMostradores[1] + CodMostradores[2] + CodMostradores[3] + CodMostradores[4] + CodMostradores[5] + CodMostradores[6] + CodMostradores[7] + CodMostradores[8] +
                "\n";}
    }

    public static class AB05{
        private String numeroMedidor = "";
        private TipoMedidor tipoMedidor = TipoMedidor.Hospedeiro;
        private byte ModoEspecial = 0;
        private byte Calibracao = 0;

        public AB05 comNumerMedidor(String numeroMedidor, int metodo) {
            this.tipoMedidor = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.numeroMedidor = numeroMedidor;
            return this;
        }

        public  byte[] build(int metodo){
            byte[] cabecalho = GeraNumeroMedidor(tipoMedidor, numeroMedidor, metodo);
            byte[] corpo = GeraCorpoPerguntaEstendida(ProtocoloAbsoluto.AB05);
            corpo[5] = ModoEspecial;
            corpo[7] = Calibracao;

            return GeraMensagem(cabecalho, corpo);
        }
        public byte getModoEspecial() {
            return ModoEspecial;
        }

        public void setModoEspecial(byte ModoEspecial) {
            this.ModoEspecial = ModoEspecial;
        }

        public byte getCalibracao(){
            return Calibracao;
        }

        public void setCalibracao(byte Calibracao) {
    ...
    public static class AB14{
        private String numeroMedidor = "";
        private TipoMedidor tipoMedidor = TipoMedidor.Hospedeiro;
        private byte ModoEspecial = 0;
        private byte Calibracao = 0;

        public AB14 comNumerMedidor(String numeroMedidor, int metodo) {
            this.tipoMedidor = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.numeroMedidor = numeroMedidor;
            return this;
        }
        ...
        public  byte[] build(int metodo){
            byte[] cabecalho = GeraNumeroMedidor(tipoMedidor, numeroMedidor, metodo);
            byte[] corpo = GeraCorpoPerguntaEstendida(ProtocoloAbsoluto.AB14);
            corpo[5] = 0x00;
    ...
    public static class AB08 {
        ...
        public AB08 comMedidorNumero(String numeroMedidor, int metodo) {
            this.numeroMedidor = numeroMedidor;
            this.tipoMedidor = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            return this;
        }
    ...
    public static class LimpezaOcorrenciasMedidor {
        ...
        public LimpezaOcorrenciasMedidor comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }
        ...
        public byte[] build(boolean isAbsoluto, int metodo) {
            if (!isAbsoluto) {
    ...
    public static class AB06AlteracaoCorteReligamento {
        ...
        public AB06AlteracaoCorteReligamento comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }
    ...
    public static class AB11SolicitacaoAberturaSessao {
        ...
        public AB11SolicitacaoAberturaSessao comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }
    ...
    public static class ABNT21 {
        ...
        public ABNT21 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }
    ...
    public static class ABNT29 {
        ...
        public ABNT29 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(Calendar data, boolean isAbsoluto, int metodo) {
            if (!isAbsoluto) {
                tipo = TipoMedidor.Outros;
            }
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
    ...
    public static class ABNT30 {
        ...
        public ABNT30 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(Calendar hora, boolean isAbsoluto, int metodo) {
            if (!isAbsoluto) {
                tipo = TipoMedidor.Outros;
            }
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
    ...
    public static class EB17 {
        ...
        private byte ValeAlteracoes2 = 0;
        ...
        private boolean isAlteracaoModoPrateleira = false;
        ...
        public byte[] build() {
            ...
            if(isAlteracaoModoPrateleira) {
                ValeAlteracoes2 |= 0x01;
            }

            corpo[6] = ValeAlteracoes;
            corpo[7] = ValeAlteracoes2; // NULL
        ...
        public void setAlteracaoModoPrateleira(boolean bModoPrateleira) {
            isAlteracaoModoPrateleira = bModoPrateleira;
        }
        ...
        public byte getModoPrateleira() {
            return ModoPrateleira;
        }

        public void setModoPrateleira(byte ModoPrateleira) {
            this.ModoPrateleira = ModoPrateleira;
        }
        ...
        public String toString() {
            return "EB17 {" +
                    ...
                    "\nModo Prateleira Comando: " + ModoPrateleira +
                    "\n}";
        }
    }
    ...
    public static class AB21LeituraRegistradoresAtuais {
        ...
        public AB21LeituraRegistradoresAtuais comMedidorNumero(String numeroMedidor, boolean isEasyTrafo, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
    ...
    public static class ABNT95 {
        ...
        public ABNT95 comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }

        public byte[] build(byte ligacao, int metodo) {
            byte[] cabecalho = GeraNumeroMedidor(tipo, ns_medidor, metodo);
    ...
    public static class ABNT14GrandezasInstantaneas {
        ...
        public ABNT14GrandezasInstantaneas comMedidorNumero(String numeroMedidor, int metodo) {
            this.tipo = ProtocoloAbsoluto.TipoMedidorPeloNumeroMedidor(numeroMedidor, metodo);
            this.ns_medidor = numeroMedidor;
            return this;
        }
    ...
    private static byte[] GeraNumeroMedidor(TipoMedidor tipoMedidor, String nsMedidor, int metodo) {
        byte[] cabecalho = {0x00, 0x00, 0x00, 0x00};
